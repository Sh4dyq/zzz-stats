...
## Статические иконки (положить файлы сюда) — Этап A
...
## Динамические картинки — Этап B (через Supabase Storage, НЕ сюда)

`characters/` и `amplifiers/` здесь — заглушки. На Этапе B портреты/иконки
